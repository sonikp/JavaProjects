...
// another good example of good parallel columns for displaying data intake
...
public class Horizontal_SequentialGroup extends JFrame {
    ...
    public Horizontal_SequentialGroup(int levels, int slots) {
...
//@formatter:on
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(() -> new Horizontal_SequentialGroup(5, 5));
    }
}