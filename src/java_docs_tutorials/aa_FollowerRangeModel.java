 ...
 *
 */
public class aa_FollowerRangeModel extends aa_ConverterRangeModel
                                implements ChangeListener {
    aa_ConverterRangeModel sourceModel; //the real model

    /** Creates a FollowerRangeModel that gets its state from sourceModel. */
    public aa_FollowerRangeModel(aa_ConverterRangeModel sourceModel) {
