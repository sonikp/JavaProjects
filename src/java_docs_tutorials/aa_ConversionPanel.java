...
public class aa_ConversionPanel extends JPanel
    ...
    JSlider slider;
    aa_ConverterRangeModel sliderModel;
    aa_Converter_Main controller;
    aa_Unit[] units;
    String title;
    ...
    aa_ConversionPanel(aa_Converter_Main myController, String myTitle,
                    aa_Unit[] myUnits,
                    aa_ConverterRangeModel myModel) {
        if (MULTICOLORED) {
            setOpaque(true);
