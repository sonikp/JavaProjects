 ...
 */
public class dd_TableDialogEditDemo_Main extends JPanel {
    private boolean DEBUG = false;

    public dd_TableDialogEditDemo_Main() {
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new dd_TableDialogEditDemo_Main();
