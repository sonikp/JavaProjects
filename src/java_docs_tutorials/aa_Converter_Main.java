...
public class aa_Converter_Main {
    aa_ConversionPanel metricPanel, usaPanel;
    aa_Unit[] metricDistances = new aa_Unit[3];
    aa_Unit[] usaDistances = new aa_Unit[4];
    ...
    aa_ConverterRangeModel dataModel = new aa_ConverterRangeModel();
    JPanel mainPane;
     ...
     */
    public aa_Converter_Main() {
        //Create Unit objects for metric distances, and then
        //instantiate a ConversionPanel with these Units.
        metricDistances[0] = new aa_Unit("Centimeters", 0.01);
        metricDistances[1] = new aa_Unit("Meters", 1.0);
        metricDistances[2] = new aa_Unit("Kilometers", 1000.0);
        metricPanel = new aa_ConversionPanel(this, "Metric System", metricDistances, dataModel);

        //Create Unit objects for U.S. distances, and then
        //instantiate a ConversionPanel with these Units.
        usaDistances[0] = new aa_Unit("Inches", 0.0254);
        usaDistances[1] = new aa_Unit("Feet", 0.305);
        usaDistances[2] = new aa_Unit("Yards", 0.914);
        usaDistances[3] = new aa_Unit("Miles", 1613.0);
        usaPanel = new aa_ConversionPanel(this, "U.S. System",
                                       usaDistances,
                                       new aa_FollowerRangeModel(dataModel));
    ...
    public void resetMaxValues(boolean resetCurrentValues) {
        ...
        int maximum = aa_ConversionPanel.MAX;

        if (metricMultiplier > usaMultiplier) {
            maximum = (int)(aa_ConversionPanel.MAX *
    ...
    private static void createAndShowGUI() {
        ...
        aa_Converter_Main converter = new aa_Converter_Main();
